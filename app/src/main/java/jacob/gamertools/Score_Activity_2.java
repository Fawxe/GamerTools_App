...
/*
        ...
        int preset_Minor_Up_2 = sharedPref.getInt(getString(R.string.preset_Minor_Up_2), 1);
        int preset_Major_Up_2 = sharedPref.getInt(getString(R.string.preset_Major_Up_2), 10);
        int preset_Minor_Down_2 = sharedPref.getInt(getString(R.string.preset_Minor_Down_2), 1);
        int preset_Major_Down_2 = sharedPref.getInt(getString(R.string.preset_Major_Down_2), 10);

        variables.setLarge_decrease(preset_Major_Down_2);
        variables.setLarge_increase(preset_Major_Up_2);
        variables.setSmall_increase(preset_Minor_Up_2);
        variables.setSmall_decrease(preset_Minor_Down_2);
*/
    }
...
/*
        ...
        editor.putInt(getString(R.string.preset_Major_Down_2), variables.getLarge_decrease());
        editor.putInt(getString(R.string.preset_Major_Up_2), variables.getLarge_increase());
        editor.putInt(getString(R.string.preset_Minor_Down_2), variables.getSmall_decrease());
        editor.putInt(getString(R.string.preset_Minor_Up_2), variables.getSmall_increase());
        editor.commit();
*/
